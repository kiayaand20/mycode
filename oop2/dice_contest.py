...
# import our classes
from cheatdice import * # the star is importing all classes from cheatdice module
...
def main():
    ...
    number_of_games = 100000 # not sure why we are running this many games but here we are
    game_number = 0
